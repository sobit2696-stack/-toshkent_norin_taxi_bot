...
def admin_button():
    ...
    kb.add(InlineKeyboardButton("📞 Admin bilan bog'lanish", url=f"https://t.me/{ADMIN_USERNAME}"))
    return kb
...
async def cmd_start(message: types.Message):
    await message.answer(
        "🚖 *Toshkent Norin Taxi*\n\n"
        "Assalomu alaykum! Xizmatimizdan foydalanish uchun quyidagi tugmalardan birini bosing:",
        parse_mode="Markdown",
